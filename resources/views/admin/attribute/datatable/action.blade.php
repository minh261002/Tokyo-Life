<a href="{{ route('admin.attribute.variations', $id) }}" class="btn btn-sm btn-info">
    <i class="ti ti-list fs-1"></i>
</a>

<a href="{{ route('admin.attribute.edit', $id) }}" class="btn btn-sm btn-primary">
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="{{ route('admin.attribute.delete', $id) }}" class="btn btn-danger w-100 btn-delete"
